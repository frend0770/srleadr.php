<?php 
ob_start();
$token = "5632189291:AAHJEin93MG31rih2mNKoMAbrwuqdDruU1E"; 
...
'parse_mode'=>"markdown",
  'reply_markup'=>json_encode([ 
      'inline_keyboard'=>[
[['text'=>'• Instagram services / خدمات انستكرام •' ,'url'=>"t.me/TSInstabotBOT"]],
]])
]);return false;
...
- لشراء النقاط  أو تبليغ عن مشكله يرجه مراسله المطور [@BBI4BB]
",
    'parse_mode'=>"MarkDown",
   'disable_web_page_preview'=>true,
'parse_mode'=>"markdown",
...
- عذرا عزيزي رصيدك لا يكفي قم بمراسله المطور لشحن رصيدك => [@G_GGSG]
		',
	]);
$done["mode"][$from_id] = null;
$done = json_encode($done,true);
